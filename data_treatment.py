...
range_to_remove=[]
moving_average_period=10*10 #10s @ acquisition rate of 10

#endregion

df_data=pd.read_excel(r'C:\Users\JoãoGonçaloCouto\PycharmProjects\arduino\data\2020.5.22_11.15.36__nominal_uncertainty.xls')
...
l2_1_2=ax2_1.plot(df_data['Relative Time - [s]'],df_data[variables_to_treat[1]],label='Raw Data: '+variables_to_treat[1],alpha=0.5)
